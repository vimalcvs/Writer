...
class RecyclerAdapter(context: Context, interstitial: InterstitialAd)
    ...
    override fun getItemCount(): Int {
        Log.println(Log.ASSERT,"Item Recycler", "${IndexData.index.size}")
    ...
    private fun dataChanged(x: Int, postData: PostData, data: DataSnapshot, holder: ViewHolder) {
        try {
            ...
            val comments = holder.itemView.findViewById<TextView>(R.id.comments)
            val ver = holder.itemView.findViewById<ImageView>(R.id.verified_logo)
            ...
            postModel.ver = data.child("Verified").value.toString()
            ...
            if (postModel.ver=="True") ver.visibility = View.VISIBLE
            else ver.visibility = View.INVISIBLE
            ...
            holder.itemView.setOnClickListener {
                ...
                intent.putExtra("VERIFIED", postModel.ver)
                intent.putExtra(
                    "DESCRIPTION",
